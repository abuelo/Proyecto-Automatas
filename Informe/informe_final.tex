...
\begin{itemize}
 ...
 operador $Manual$ para dar paso al control manual del sistema.
  ...
  \item $Emergency$: Durante todo el proceso pueden ocurrir inconvenientes que afecten el 
  funcionamiento del sistema y que lleven a una situación de peligro. Tales situaciones pueden
  ser detectadas por el sistema: $Away$ cuando la carga responde de manera opuesta a lo esperado
  o por el operario mediante la señal de $Emer$ para dar aviso de un comportamiento anómalo del 
  modo automático. Así durante todo el funcionamiento del autómata se puede llegar al estado de
  emergencia $Emergency$ el cual se encarga de detener el movimiento de la carga para pasar el 
  mando al operario. 
 \end{itemize}
