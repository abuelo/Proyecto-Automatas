...
\begin{itemize}
 ...
 \item Posición inicial del carro: $xt\_h = -15.0$
 
 El carro comienza quince metros dentro del puerto.
 \item Longitud inicial de cable desenrrollado: $lh\_h = yt0-yl0- \dfrac{mL \, g}{Kw} $ 
 ...
 \item Longitud mínima de cable desenrrollado: $lh\_min = yt0 - yl\_max-\dfrac{mL \, g}{Kw}$
 ...
 \item Posición final del carro:$xt\_g= (numColumna + 0.5) \, wContainer$
...
En la figura \ref{fig:bloque_consigna_pos} se puede observar el bloque en Matlab-Simulink
...
se observa en la figura \ref{fig:consigna_pos}.
\begin{figure}[!t]
 \centering
